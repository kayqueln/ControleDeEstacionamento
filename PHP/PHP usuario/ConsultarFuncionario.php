...
include_once "Menu_exemplo_usuario.html";
    ...
    if (!$num_rows > 0) {
        echo '<div class="form">'.'Funcionário não encontrado!'.'<br><br><a class="btt" href="../../HTML/HTML usuario/ConsultarFuncionario.html">VOLTAR</a>'.'</div>'; 
    }
    else{
        ...
        while($funcionario = mysqli_fetch_array($resultado)){
            ...
            "<br/><br/><a class='btt' href='../../HTML/HTML usuario/ConsultarFuncionario.html'>VOLTAR</a>".
            '</div>'."<br>";
